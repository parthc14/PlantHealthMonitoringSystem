...
% varargin   com4and line arguments to sample (see VARARGIN)

% Choose default com4and line output for sample
...
% --- Outputs from this function are returned to the com4and line.
...
% Get default com4and line output from handles structure
...
% figure
% imshow(img)
% title('Com4lete Image after Median Filtering')
...
% title('Gray Region Identification - All channels Com4ined')
jc = 0;
% imshow(img_thresh)
axes(handles.target);
imshow(img)
...
%     [maxno largestBlobNo] = max(sizeblob);
    ...
    elseif j > 0 & jc == 0
        ...
        hold on
         ...
         pause(1)
         fprintf(ser_gsm,'at+cmgs="+919167794660"');
         pause(0.5)
    ...
    elseif jc > 0 & j == 0
        ...
        for i=1:jc
         ...
         fprintf(ser_gsm,'at+cmgf=1');
         pause(1)
         fprintf(ser_gsm,'at+cmgs="+917021615062"');
         pause(0.5)
         ser_gsm.terminator = 26;
...
% hObject    handle to figure1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with1 handles and user data (see GUIDATA)
